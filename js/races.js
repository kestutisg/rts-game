...
export const RACES = {
  gdi: {
    ...
    unitModifiers: {
      ...
      disc_thrower: { damage: 1.1 },
      jumpjet: { speed: 1.05 },
      ghost_stalker: { damage: 1.1 },
    },
    buildingModifiers: {
      cyard: { maxHealth: 1.1 },
    ...
    buildings: {
      ...
      fence: 'Concrete Wall',
      gate: 'Gate',
      turret: 'Component Tower (Vulcan)',
      laser: 'Sonic Emitter',
      explosive_tower: 'Component Tower (RPG)',
    },
    units: {
      light_infantry: 'Light Infantry',
      disc_thrower: 'Disc Thrower',
      engineer: 'GDI Engineer',
      medic: 'Field Medic',
      jumpjet: 'Jump Jet Infantry',
      ghost_stalker: 'Ghost Stalker',
      harvester: 'Harvester',
      motorcycle: 'Pitbull',
      buggy: 'Humvee',
      tank: 'Predator Tank',
      plane: 'Orca Fighter',
      sensor_array: 'Mobile Sensor Array',
  ...
  nod: {
    ...
    unitModifiers: {
      ...
      rocket_infantry: { damage: 1.1 },
      cyborg: { maxHealth: 1.15 },
      hijacker: { speed: 1.1 },
    },
    buildingModifiers: {
    ...
    units: {
      light_infantry: 'Nod Militant',
      rocket_infantry: 'Rocket Infantry',
      engineer: 'Nod Engineer',
      cyborg: 'Cyborg',
      cyborg_commando: 'Cyborg Commando',
      hijacker: 'Mutant Hijacker',
